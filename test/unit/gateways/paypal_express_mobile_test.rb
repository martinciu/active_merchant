...
class PaymentExpressMobileTest < Test::Unit::TestCase
  def setup
        
    @gateway = PaymentExpressMobileGateway.new(
      :login => 'LOGIN',
      :password => 'PASSWORD'
    )
  ...
  def test_default_currency
    assert_equal 'NZD', PaymentExpressMobileGateway.default_currency
  end
  ...
  def test_supported_countries
     assert_equal ['AU','MY','NZ','SG','ZA','GB','US'], PaymentExpressMobileGateway.supported_countries
   end

  def test_supported_card_types
   assert_equal [ :visa, :master, :american_express, :diners_club, :jcb ], PaymentExpressMobileGateway.supported_cardtypes
  end
